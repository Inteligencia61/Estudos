# =========================
# Apartamento_Park_Sul.py  (EXECUTA VIA IMPORTLIB)
...
# CONFIG DESTE SCRIPT
# =========================
RANGE_NAME = "Apartamento_Park_Sul!A1"
...
print(f"[INFO] Rodando Apartamento_Park_Sul.py | Data={data_ref} | arquivo={input_file}")
