# =========================
# Apartamento_Noroeste.py  (EXECUTA VIA IMPORTLIB)
...
# CONFIG DESTE SCRIPT
# =========================
RANGE_NAME = "Apartamento_Noroeste!A1"
...
print(f"[INFO] Rodando Apartamento_Noroeste.py | Data={data_ref} | arquivo={input_file}")
