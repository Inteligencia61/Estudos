# =========================
# Apartamento_Asa_Norte.py  (EXECUTA VIA IMPORTLIB)
...
# CONFIG DESTE SCRIPT
# =========================
RANGE_NAME = "Apartamento_Asa_Norte!A1"
...
print(f"[INFO] Rodando Apartamento_Asa_Norte.py | Data={data_ref} | arquivo={input_file}")
