# =========================
# Apartamento_Sudoeste.py  (EXECUTA VIA IMPORTLIB)
...
# CONFIG DESTE SCRIPT
# =========================
RANGE_NAME = "Apartamento_Sudoeste!A1"
...
print(f"[INFO] Rodando Apartamento_Sudoeste.py | Data={data_ref} | arquivo={input_file}")
