...
# FIX: só filtra por oferta se o valor desejado existir na coluna.
# Ex.: se a coluna tiver "PUBLICADO" e você pede "VENDA",
#      não vamos zerar o dataset; apenas ignoramos esse filtro.
...
RANGE_NAME = "Casa_Arniqueira!A1"
TIPO_IMOVEL = "Casa"
BAIRRO = "ARNIQUEIRA"
CIDADE = None
QUADRA = None

print(f"[INFO] Rodando ARNIQUEIRA | Data={data_ref} | arquivo={input_file}")
